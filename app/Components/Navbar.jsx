      ...
      >
        <MenuHandler>
          <Typography as="div" variant="small" className="font-medium">
            <ListItem
              className="flex items-center gap-2 py-2 pr-4 font-medium text-gray-900 text-l"
...
function NavList() {
  return (
    <List className="mt-4 mb-6 p-0 lg:mt-0 lg:mb-0 lg:flex-row lg:p-1">
      ...
      >
        <ListItem className="flex items-center gap-2 py-2 pr-4 text-l">Home</ListItem>
      </Typography>
      <NavListMenu />
      <Typography
        as="a"
  ...
  return (
    <div className="w-full z-50">
      <Navbar fullWidth className="fixed top-0 z-50 bg-white shadow-md">
        <div className="xlg:px-0 lg:py-0">
